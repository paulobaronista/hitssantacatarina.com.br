...
<div id="home" class="container-fluid padding-off home">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-lg-offset-1 padding-off-mobile">
                <div class="galeria">
                    <section class="glr-home slider">
                        ...
                        <div>
                            <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/galeria/galeria-home-04.png" alt="Hits Santa Catarina">
                        </div>
                        <div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 box-clique">
                <div class="col-xs-4 padding-off"></div>
                <div class="col-xs-8 col-sm-12 col-md-12 padding-off img-clique">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <p>
                    ...
                    É estar perto do que você gosta.<br class="hidden-xs" />
                    Sucesso de verdade é ver seus ﬁlhos crescerem com alegria e segurança.<br class="hidden-xs" />
                    É colocar em prática seus projetos e realizar seus sonhos.<br class="hidden-xs" />
                    Porque, no ﬁnal das contas, a verdade é uma só: o único sucesso<br class="hidden-xs" />
...
<div id="projeto" class="container-fluid padding-off faixa-vermelho">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                <p>VIVER BEM É O SEU <br class="visible-xs" />NOVO PROJETO.</p>
            </div>
        </div>
    </div>
</div>
...
<div id="implantacao" class="container-fluid padding-off faixa-verde">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                <p>IMPLANTAÇÃO</p>
...
<div id="lazer" class="container-fluid padding-off faixa-roxo">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
...
<div id="localizacao" class="container-fluid padding-off faixa-azul">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                ...
                <div class="col-xs-12 col-sm-10 col-md-9 col-lg-9 padding-off txt">
                    <p>
                        A <strong>Vila Santa Catarina</strong> oferece fácil acesso à região da Berrini, contando com diversas
                        linhas de ônibus que passam pelas avenidas Santa Catarina, Cupecê e Washington Luís.
                        Oferece total infraestrutura e está a apenas 10 minutos de carro do Morumbi Shopping.
                        Você irá viver em um bairro completo e que se valoriza a cada dia.
                    </p>
                </div>
...
<div id="aviso" class="aviso text-center">
    <div>
        ...
        <p>O e-mail não pode ser enviado!<br />
            ...
            Se o problema persistir, entre em contato pelo Telefone <strong>contato@hitssantacatarina.com.br</strong>
        </p>
    </div>
</div>