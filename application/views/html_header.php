...
<head>
    ...
    <meta name="title" content="Hits Santa Catarina" />
    <meta name="og:title" content="Hits Santa Catarina" />
    ...
    <meta property="og:title" content="Hits Santa Catarina" />
    ...
    echo meta($meta);
    echo link_tag('assets/css/bootstrap.css?v=0.0.1');
    echo link_tag('assets/css/style.css?v=0.0.1');
    echo link_tag('assets/css/slick.css?v=0.0.1');
    echo link_tag('assets/css/slick-theme.css?v=0.0.1');
    echo link_tag('assets/css/lity.css');
    ?>
